...
export const GamesList: FC = memo(() => {
    ...
    if (loading === 'failed') navigate('/error');
    ...
    return (
        <section className={'w-full my-4'}>
            ...
            <div className={'lg:ml-64'}>
                ...
                <div
                    className={
                        'flex space-x-2 w-full overflow-x-auto lg:flex-none lg:space-x-0 lg:overflow-x-visible lg:grid lg:gap-x-4 lg:grid-cols-3 lg:gap-y-4 xl:grid-cols-4'
                    }
                >
                    {loading === 'succeeded' &&
                        games.map((game) => (
