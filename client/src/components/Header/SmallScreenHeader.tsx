...
const SmallScreenHeader: FC = () => {
    return (
        <header
            className={"w-full border-b border-slate-500/30 lg:hidden sticky top-0 z-10 bg-white dark:backdrop-blur dark:bg-slate-900/80 shadow-lg dark:shadow-none shadow-gray-500/10"}>
